...
<head>
  ...
  <title>LiveTech | Dashboard</title>
...
$header = '<header class="main-header">
    ...
    <a href="' . $url . '" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b> <b>Live Tech</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-warning text-yellow"></i> Seu estoque esta do produto "MacBook Pro 11" esta perto do minimo
                    </a>
                  </li>
                  <li>
                    <a href="#">
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 pedidos de compras finalizados
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-user text-red"></i> Usuário "Guilherme" cadastrado com sucesso
                    </a>
                  </li>
                </ul>
              </li>
...
$header .= ' <small>Member since Nov. 2012</small>
              ...
              <li class="user-footer">
                <div class="pull-left">
              <a href="' . $url . 'usuarios/profileN.php" class="btn btn-default btn-flat">Profile</a>
                </div>
...
$footer = '<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="http://LiveTechConnect.shop">Live Tech Group</a>.</strong> All rights
    reserved.
  </footer>
